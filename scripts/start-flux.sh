...
echo ""
echo "=============================================="
echo "  Flux CD ready (Operator + apps + monitoring)"
echo "=============================================="
echo ""
...
echo ""
echo "Grafana (CPU / memory / logs dashboard):"
echo "  kubectl port-forward -n monitoring svc/kube-prometheus-stack-grafana 3000:80"
echo "  http://localhost:3000"
echo "  admin / admin   OR   viewer / viewer  (Viewer role)"
echo "  Dashboard: Flux Apps — CPU, Memory & Logs"
echo ""
echo "K8s read-only user (viewer):"
echo "  ./scripts/create-viewer-kubeconfig.sh"
echo "  KUBECONFIG=~/.kube/viewer-newprofile.kubeconfig kubectl get pods -n flux-fastapi-ns"
echo ""
echo "App logs (kubectl):"
echo "  kubectl logs -n flux-fastapi-ns deploy/fastapi -f"
echo "App logs (Grafana Explore → Loki):"
echo "  {namespace=\"flux-fastapi-ns\"}"
echo ""
